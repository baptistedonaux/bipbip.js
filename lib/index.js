...
var Bipbip = function(path, env) {
	...
	if (typeof envConfig.repository === "object"
		&& envConfig.repository !== null
		&& envConfig.repository.url !== null
		&& (envConfig.repository.branch === null
			&& envConfig.repository.tag === null))
	{
...
Bipbip.prototype.send = function() {
	...
	var lastRelease = this._execRemote("ls -1t " + this.config.server.to + "/releases | head -n 1");
